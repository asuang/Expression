...
list=[]
list2=[]
file=open("D:\\研究生\\密码子\\multi_cellline\\total.txt",'r+')
...
for line in gene:
    ...
    if gr:
        ...
        seq[gn]=line
with open("D:/研究生/密码子/multi_cellline/count.csv", 'w+',newline='') as count:
...
for line in file:
    ...
    if D:
        del codon[D]
    with open("D:/研究生/密码子/multi_cellline/count.csv",'a',newline='') as count:
        writer=csv.writer(count)
